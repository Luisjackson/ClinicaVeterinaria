...
private String name;
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Liberation Sans", 0, 27)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(64, 91, 109));
        jLabel1.setText("SISTEMA DE GERENCIAMENTO DE CLÍNICAS");
        ...
        jLabel3.setText("CADASTRO DE CLÍNICA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Nome salvo: " + this.name); // só para testar
        Clinica cli = new Clinica(this.name);
