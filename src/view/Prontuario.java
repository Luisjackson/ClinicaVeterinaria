...
public class Prontuario extends javax.swing.JFrame {
    ...
    public Prontuario(Animal animal, Clinica clinica) {
        initComponents();
        
        String relatorio = clinica.emitirProntuario(animal);

        // Exibe o relatório na área de texto
        jTextAreaProntuario.setText(relatorio);
    }
    ...
    private void initComponents() {
        ...
        jTextAreaProntuario = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jLabel1.setText("DADOS DO PRONTUARIO");

        jTextAreaProntuario.setColumns(20);
        jTextAreaProntuario.setRows(5);
        jScrollPane1.setViewportView(jTextAreaProntuario);
